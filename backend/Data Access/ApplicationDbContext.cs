    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.Salt).IsRequired(false); //Make Salt nullable
            });
        ...
        modelBuilder.Entity<Artwork>(entity =>
        {
            ...
            // Configure image columns to handle large base64 data (unlimited size)
            entity.Property(a => a.AiImage).HasColumnType("nvarchar(max)");
            entity.Property(a => a.SketchedImage).HasColumnType("nvarchar(max)");
            ...
            entity.OwnsMany(a => a.Paths, p =>
            {
                ...
                p.Property(pd => pd.Path).HasColumnName("Paths").HasColumnType("nvarchar(max)");
            });
        });
